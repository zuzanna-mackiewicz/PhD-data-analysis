...
final_74_83_1 <- read.csv("final_74_83_1.csv")
final_74_83_2 <- read.csv("final_74_83_2.csv")
final_74_83_3 <- read.csv("final_74_83_3.csv")
final_74_83_2_3 <- read.csv("final_83_74_2_3.csv")
final_74_83_1_2_3 <- read.csv("final_74_83_1_2_3.csv")
final_N2_83_2 <- read.csv("final_83_N2_2.csv")
final_N2_83_3 <- read.csv("final_83_N2_3.csv")
final_N2_83_2_3 <- read.csv("final_N2_83_2_3.csv")
final_N2_74_2 <- read.csv("final_74_N2_2.csv")
final_N2_74_3 <- read.csv("final_74_N2_3.csv")
final_N2_74_2_3 <- read.csv("final_N2_74_2_3.csv")

final_male <- read.csv("final_male_herm.csv")
final_N2_NSPC <- read.csv("final_N2_NSPC.csv")
final_N2_tm <- read.csv("final_N2_tm.csv")
