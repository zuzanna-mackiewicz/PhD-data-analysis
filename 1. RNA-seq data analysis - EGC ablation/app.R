...
final_74_83_1 <- read.csv("~/shiny_app/rna_seq_app/ablation/final_74_83_1.csv")
final_74_83_2 <- read.csv("~/shiny_app/rna_seq_app/ablation/final_74_83_2.csv")
final_74_83_3 <- read.csv("~/shiny_app/rna_seq_app/ablation/final_74_83_3.csv")
final_74_83_2_3 <- read.csv("~/shiny_app/rna_seq_app/ablation/final_83_74_2_3.csv")
final_74_83_1_2_3 <- read.csv("~/shiny_app/rna_seq_app/ablation/final_74_83_1_2_3.csv")
final_N2_83_2 <- read.csv("~/shiny_app/rna_seq_app/ablation/final_83_N2_2.csv")
final_N2_83_3 <- read.csv("~/shiny_app/rna_seq_app/ablation/final_83_N2_3.csv")
final_N2_83_2_3 <- read.csv("~/shiny_app/rna_seq_app/ablation/final_N2_83_2_3.csv")
final_N2_74_2 <- read.csv("~/shiny_app/rna_seq_app/ablation/final_74_N2_2.csv")
final_N2_74_3 <- read.csv("~/shiny_app/rna_seq_app/ablation/final_74_N2_3.csv")
final_N2_74_2_3 <- read.csv("~/shiny_app/rna_seq_app/ablation/final_N2_74_2_3.csv")

final_male <- read.csv("~/shiny_app/rna_seq_app/ablation/final_male_herm.csv")
final_N2_NSPC <- read.csv("~/shiny_app/rna_seq_app/ablation/final_N2_NSPC.csv")
final_N2_tm <- read.csv("~/shiny_app/rna_seq_app/ablation/final_N2_tm.csv")
...
# Main table  
  output$table <- DT::renderDataTable({
    ...
    {table <- final_N2_74_2_3[,c(9,2:3,6:8,1,13:15,19:21,10:12,16:18)] %>% 
      ...
      dplyr::mutate(across(c(baseMean:log2FoldChange), round, digits = 3)) %>% 
      dplyr::mutate(across(c(pvalue:padj), signif, digits = 2))}
    else if(input$experiment == "N2 hermaphrodites vs males")
