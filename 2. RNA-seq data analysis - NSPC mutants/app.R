...
final_tm_NSPCtm <- read.csv("final_tm_NSPCtm.csv")
final_daf_NSPCdaf <- read.csv("final_daf_NSPCdaf.csv")
final_N2_tm <- read.csv("final_N2_tm.csv")
final_N2_daf <- read.csv("final_N2_daf.csv")
final_NSPC_NSPCtm <- read.csv("final_NSPC_NSPCtm.csv")
final_NSPC_NSPCdaf <- read.csv("final_NSPC_NSPCdaf.csv")
final_N2_NSPCtm <- read.csv("final_N2_NSPCtm.csv")
final_N2_NSPCdaf <- read.csv("final_N2_NSPCdaf.csv")

final_rnai <- read.csv("final_rnai.csv")
