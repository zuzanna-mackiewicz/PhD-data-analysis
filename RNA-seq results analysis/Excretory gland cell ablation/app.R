...
final_74_83_1 <- read_excel("final_74_83_1.xlsx")
final_74_83_2 <- read_excel("final_74_83_2.xlsx")
final_74_83_3 <- read_excel("final_74_83_3.xlsx")
final_74_83_2_3 <- read_excel("final_83_74_2_3.xlsx")
final_74_83_1_2_3 <- read_excel("final_74_83_1_2_3.xlsx")
final_N2_83_2 <- read_excel("final_83_N2_2.xlsx")
final_N2_83_3 <- read_excel("final_83_N2_3.xlsx")
final_N2_83_2_3 <- read_excel("final_N2_83_2_3.xlsx")
final_N2_74_2 <- read_excel("final_74_N2_2.xlsx")
final_N2_74_3 <- read_excel("final_74_N2_3.xlsx")
final_N2_74_2_3 <- read_excel("final_N2_74_2_3.xlsx")

final_male <- read_excel("final_new_diffexp_males_vs_herm.xlsx")
final_N2_NSPC <- read_excel("final_N2_NSPC.xlsx")
final_N2_tm <- read_excel("final_N2_tm.xlsx")
...
# Main plot  
  output$MAplot <- renderPlot({
    ...
    {return(ggplot(plot, aes(x=baseMean, y= log2FoldChange, color=sig)) 
           + ggtitle(input$experiment) + geom_point(size = 3 ,alpha = 0.3) 
           + scale_color_manual(values=c("gray70", "red")) + theme_light() 
           + geom_point(data=group, size =3, color="black", shape = 21) 
